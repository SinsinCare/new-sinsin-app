 ...
 * 보더리스가 정책이고(`V2Chip` 머리말), 미선택 칩의 `fill.control` 면이 흰 바닥 위에서
 * 경계 노릇을 한다(2026-08-21 에 `fill.normal` 에서 갈라져 그 노릇을 실제로 하게 됐다 —
 * 그전에는 ΔL* 3.79 라 "이미 경계 노릇을 한다" 가 사실이 아니었다). 보더를 넣으면 선택/미선택 사이에서 칩 폭이 흔들리거나
