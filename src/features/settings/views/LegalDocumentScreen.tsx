...
function useLegalColors() {
  ...
  return {
    ...
    headerText: colors.label.normal,
    heading: colors.label.normal,
    heading2: colors.label.normal,
    heading3: colors.label.normal,
    body: colors.label.neutral,
    note: colors.label.neutral,
  }
}
...
export function LegalDocumentScreen() {
  ...
  return (
    <ThemedView style={[styles.container, { backgroundColor: c.bg }]}>
      ...
      <SettingsDetailHeader
        title={t(
          isPrivacyPolicy ? "settings.legal.privacy" : "settings.legal.terms",
        )}
        onBack={router.back}
      />
